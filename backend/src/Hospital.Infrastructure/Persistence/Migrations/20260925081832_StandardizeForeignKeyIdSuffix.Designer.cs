...
namespace Hospital.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260925081832_StandardizeForeignKeyIdSuffix")]
    partial class StandardizeForeignKeyIdSuffix
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hospital.Domain.Entities.TreatmentSchedule", b =>
                {
                    ...
                    b.HasIndex("TreatmentId", "DayOfWeek")
                        .HasDatabaseName("ix_schedules_treatment_day");

                    b.HasIndex("TreatmentId", "TherapistId", "DayOfWeek", "StartTime")
                        .IsUnique()
            ...
            modelBuilder.Entity("Hospital.Domain.Entities.WorkflowExecution", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("AgentName")
                        .HasDatabaseName("ix_workflow_executions_agent_name");

                    b.HasIndex("ApprovalStatus")
                        .HasDatabaseName("ix_workflow_executions_approval_status");
            ...
            modelBuilder.Entity("Hospital.Domain.Entities.TreatmentSchedule", b =>
                {
                    b.HasOne("Hospital.Domain.Entities.Therapist", "Therapist")
                        .WithMany("Schedules")
